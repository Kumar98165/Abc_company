  ...
  return (
    <section className="relative w-full bg-[#FFFFFF] py-16 lg:py-24 text-[#101820] overflow-hidden">
      ...
      <div className="section-shell relative z-10">
        ...
        {/* BOTTOM VALUE STRIP                                 */}
        {/* ================================================== */}
        <div className="mt-16 pt-12 border-t border-[#E7E2DA]">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            
            {/* Item 1 */}
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#FFF4EC] border border-[#FFE5CC] text-[#FF6500]">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div>
                <h4 className="text-sm font-extrabold text-[#071A2B]">Enterprise Grade</h4>
                <p className="mt-1 text-xs text-[#667085] leading-relaxed">
                  Secure, reliable & scalable solutions for mission-critical business needs.
                </p>
              </div>
            </div>
            {/* Item 2 */}
            <div className="flex items-start gap-4 sm:border-l sm:border-[#E7E2DA] sm:pl-8">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#FFF4EC] border border-[#FFE5CC] text-[#FF6500]">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <div>
                <h4 className="text-sm font-extrabold text-[#071A2B]">Domain Expertise</h4>
                <p className="mt-1 text-xs text-[#667085] leading-relaxed">
                  Deep experience across industries and complex business domains.
                </p>
              </div>
            </div>
            {/* Item 3 */}
            <div className="flex items-start gap-4 lg:border-l lg:border-[#E7E2DA] lg:pl-8">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#FFF4EC] border border-[#FFE5CC] text-[#FF6500]">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                </svg>
              ...
              <div>
                <h4 className="text-sm font-extrabold text-[#071A2B]">Modern Engineering</h4>
                <p className="mt-1 text-xs text-[#667085] leading-relaxed">
                  Using the latest technologies and best practices to build future-ready products.
                </p>
              </div>
            </div>
            {/* Item 4 */}
            <div className="flex items-start gap-4 sm:border-l sm:border-[#E7E2DA] sm:pl-8">
              ...
              <div>
                <h4 className="text-sm font-extrabold text-[#071A2B]">Outcome Focused</h4>
                <p className="mt-1 text-xs text-[#667085] leading-relaxed">
                  We build solutions that drive measurable business impact and long-term value.
                </p>
              </div>
            </div>
